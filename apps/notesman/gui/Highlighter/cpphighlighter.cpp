...
// cause: elements in builtinKeywords break line so long by formatter
...
void CppHighlighter::initRules() {
    ...
    QStringList const builtinKeywords = {
        ...
        "consteval",   "constexpr", "constinit", "const_cast",   "co_await",     "co_return",
        "co_yield",    "decltype",  "double",    "dynamic_cast", "enum",         "explicit",
        "export",      "extern",    "false",     "float",        "friend",       "goto",
        "inline",      "int",       "long",      "mutable",      "namespace",    "noexcept",
        "not",         "not_eq",    "nullptr",   "operator",     "or",           "or_eq",
        "private",     "protected", "public",    "reflexpr",     "register",     "reinterpret_cast",
        "requires",    "short",     "signed",    "sizeof",       "static",       "static_assert",
        "static_cast", "struct",    "template",  "this",         "thread_local", "true",
        "typedef",     "typeid",    "typename",  "union",        "unsigned",     "virtual",
...
void CppHighlighter::highlightBlock(QString const& text) {
    ...
    applyNormalRules(text, defaultTextColor);

    // --- 2) Comments (single-line) --- apply but DO NOT override strings
    handleSingleLineComment(text);
    ...
    handleIdentifierFallback(text, defaultTextColor);
}
